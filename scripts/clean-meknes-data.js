...
const inputFile = path.join(__dirname, '../meknes.json');
const outputFile = path.join(__dirname, '../src/data/meknes.json');
...
console.log(`Successfully cleaned meknes data. Original: ${rawData.length}, Cleaned: ${cleaned.length}`);
