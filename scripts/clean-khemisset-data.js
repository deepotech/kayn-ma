...
const inputFile = path.join(__dirname, '../khemisset.json');
const outputFile = path.join(__dirname, '../src/data/khemisset.json');
...
console.log(`Successfully cleaned khemisset data. Original: ${rawData.length}, Cleaned: ${cleaned.length}`);
