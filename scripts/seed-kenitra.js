...
async function main() {
    console.log('🚀 Starting database seeding for Kenitra...');
    ...
    // Upsert City
    console.log('Upserting City: kenitra');
    const city = await prisma.city.upsert({
        where: { slug: 'kenitra' },
        update: { name: 'Kenitra', lat: 34.2610, lng: -6.5802 },
        create: { name: 'Kenitra', slug: 'kenitra', lat: 34.2610, lng: -6.5802 }
    });
    ...
    console.log(`\n=========================================`);
    console.log(`🎉 SEEDING SUMMARY FOR KENITRA`);
    console.log(`=========================================`);
