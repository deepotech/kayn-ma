...
async function main() {
    console.log("🚀 Starting database seeding for Tetouan...");
    ...
    for (const item of data) {
        const businessSlug = `${slugify(item.title)}-tetouan`;
    ...
    console.log(`\n=========================================`);
    console.log(`🎉 SEEDING SUMMARY FOR TETOUAN`);
    console.log(`=========================================`);
