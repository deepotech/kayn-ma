...
const inputFile = path.join(__dirname, '../kenitra.json');
const outputFile = path.join(__dirname, '../src/data/kenitra.json');
...
console.log(`Successfully cleaned kenitra data. Original: ${rawData.length}, Cleaned: ${cleaned.length}`);
