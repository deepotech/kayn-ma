...
const inputFile = path.join(__dirname, '../Berrechid.json');
const outputFile = path.join(__dirname, '../src/data/berrechid.json');
...
console.log(`Successfully cleaned berrechid data. Original: ${rawData.length}, Cleaned: ${cleaned.length}`);
