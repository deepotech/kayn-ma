/**
 * Casablanca Data Processing Script
 * 
 * This script:
 * 1. Reads raw Casablanca JSON data
...
function processCasablancaData() {
    const inputPath = path.join(__dirname, '../src/data/casablanca.json');
    const outputPath = path.join(__dirname, '../src/data/casablanca-cleaned.json');

    console.log('📖 Reading Casablanca data from:', inputPath);
    ...
    for (const agency of rawData) {
        ...
        const cleanedAgency: CleanedAgency = {
            ...
            city: 'casablanca', // Normalize city name
