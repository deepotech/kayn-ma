...
async function main() {
    console.log('Starting Safi Data Validation...');
    ...
    const rawFile = path.join(__dirname, '../safi.json');
    ...
    // Final Report
    console.log('\n==================================================');
    console.log('📋 VALIDATION REPORT FOR SAFI');
    console.log('==================================================');
    console.log(`Raw Businesses Count:                ${rawData.length}`);
    console.log(`Final Cleaned Count:                 ${cleanedData.length}`);
