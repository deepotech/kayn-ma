...
const inputFile = path.join(__dirname, '../oujda.json');
const outputFile = path.join(__dirname, '../src/data/oujda.json');
...
console.log(`Successfully cleaned oujda data. Original: ${rawData.length}, Cleaned: ${cleaned.length}`);
