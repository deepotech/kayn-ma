...
import { Car, Menu, Plus, Search, User, X, LogOut, ChevronDown, Sparkles, Building2 } from 'lucide-react';
                                ...
                                <>
                                    ...
                                    <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-zinc-900 rounded-xl shadow-xl border border-gray-100 dark:border-zinc-800 py-1 z-20 animate-in fade-in zoom-in-95 duration-200">
                                        ...
                                        <Link
                                            ...
                                            onClick={() => setIsUserMenuOpen(false)}
                                            className="block px-4 py-2 text-sm hover:bg-gray-50 dark:hover:bg-zinc-800 flex items-center gap-2 text-blue-600 font-medium"
                                        >
                                            <Building2 className="h-4 w-4 text-blue-600" />
                                            {t('Header.myAgency') || 'وكالة كراء السيارات'}
                                        </Link>
                                        <button
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <nav className="flex flex-col gap-2">
                                ...
                                <Link
                                    href="/dashboard/agency"
                                    onClick={toggleMenu}
                                    className="py-2 hover:text-blue-600 font-medium flex items-center gap-2 text-blue-600"
                                >
