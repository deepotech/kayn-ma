...
// Reusable Listing Detail Component - Extracted from cars/[id]/page.tsx
export default async function ListingDetailView({ id, locale }: { id: string, locale: string }) {
    ...
    const getHashedViews = (listingId: string): number => {
        let hash = 0;
